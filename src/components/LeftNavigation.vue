    ...
    >
      <div class="h-8 flex items-center">
        ...
        >
          ...
          <path d="M240.306 99.3h31.372v308.948h-31.372z" fill="#f77b55" />
          <path d="M271.65 99.3h31.395v308.948H271.65z" fill="#ee643c" />
          <circle cx="224.646" cy="99.29" r="15.69" fill="#ff916e" />
          <circle cx="256" cy="99.29" r="15.695" fill="#f77b55" />
          <path
            d="M303.073 99.284c0 8.662-7.05 15.682-15.695 15.682-8.674 0-15.7-7.02-15.7-15.682 0-8.667 7-15.682 15.7-15.682 8.646-.002 15.695 7.014 15.695 15.682z"
            fill="#ee643c"
          />
          <path d="M206.127 408.23h99.75v33.652h-99.75z" fill="#f2f2f2" />
          <path d="M271.65 408.23h34.18v33.652h-34.18z" fill="#d9d8d7" />
          <path
            d="M303.073 456.704a18.79 18.79 0 0 1-5.532 13.31c-3.68 3.674-8.5 5.51-13.316 5.51H227.78c-4.812 0-9.652-1.835-13.3-5.51-3.68-3.68-5.54-8.49-5.54-13.3v-14.822h94.14z"
            fill="#474f59"
          />
          <path
            d="M271.678 441.882v14.822a18.75 18.75 0 0 1-18.825 18.819h31.372c4.817 0 9.64-1.835 13.316-5.51 3.674-3.68 5.532-8.49 5.532-13.3v-14.822z"
            fill="#353f49"
          />
...
export default {
  name: "LeftNavigation",
  components: { NavigationButton, NavigationHeading },
  props: {
    navigation: {
      required: true,
      type: Array,
